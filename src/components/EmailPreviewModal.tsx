    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md overflow-y-auto">
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-[#141518] border border-[#2A2621] rounded-2xl shadow-2xl overflow-hidden my-8"
        >
          {/* Top Mail Client Ribbon */}
          <div className="bg-[#0D0E10] px-6 py-4 border-b border-[#2A2621] flex items-center justify-between">
          ...
          <div className="bg-[#101114] px-6 py-3 border-b border-[#1E2024] text-xs space-y-1">
            <div className="flex flex-wrap items-center justify-between text-[#8E8880]">
              <div>
                <span className="text-[#6B655B]">From:</span>{' '}
                <span className="text-white">Kanha Residency Reservations &lt;reservations@kanharesidency.com&gt;</span>
              </div>
            ...
            <div className="text-white font-medium text-sm pt-1 flex items-center justify-between">
          ...
          <div className="p-6 max-h-[60vh] overflow-y-auto space-y-6 bg-gradient-to-b from-[#141518] to-[#0F1012]">
            {/* Branded Header */}
            ...
            <div className="bg-[#181A1F] border border-[#2A2621] rounded-xl p-5 shadow-inner">
              <div className="text-sm text-[#DDD6CB] leading-relaxed whitespace-pre-wrap font-sans">
                {email.body || `Namaste ${guestName},\n\nYour reservation ${refNumber} has been recorded in our reservation management system. We look forward to welcoming you to Mathura.\n\nWarm regards,\nKanha Residency Concierge Desk`}
              </div>
            </div>
